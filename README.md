...
A knowledge base tracking Glycogen Storage Disease Type III (GSD-III), also known as Cori disease or Forbes disease — an autosomal recessive glycogen debranching enzyme (AGL) deficiency spanning subtypes IIIa, IIIb, IIIc, and IIId, with liver, cardiac, and skeletal muscle involvement.
...
<!--
  ...
  instantiation time:
    ...
    A knowledge base tracking Glycogen Storage Disease Type III (GSD-III), also known as Cori disease or Forbes disease — an autosomal recessive glycogen debranching enzyme (AGL) deficiency spanning subtypes IIIa, IIIb, IIIc, and IIId, with liver, cardiac, and skeletal muscle involvement.    Project description; default text below until edited.
